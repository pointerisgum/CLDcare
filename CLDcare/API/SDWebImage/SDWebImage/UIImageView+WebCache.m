...
- (void)sd_setImageWithString:(NSString *)str placeholderImage:(UIImage *)placeholder {
    [self sd_setImageWithURL:[NSURL URLWithString:str] placeholderImage:placeholder options:0 progress:nil completed:nil];
}

- (void)sd_setImageWithString:(NSString *)str {
